...
public class SnsStack extends Stack {
    ...
    public SnsStack(final Construct scope, final String id, final StackProps props) {
        ...
        // Inscrever email no topic -> Depois vamos inscrever nossa fila
        productEventsTopic.getTopic().addSubscription(EmailSubscription.Builder.create("guilherme.rddev@gmail.com")
                .json(true)
                .build());
    }
